...
int main()
{
  ...
  std::vector<int> ids = std::vector<int> (2);
  std::vector<std::string> models = std::vector<std::string> (2);
  models = {"0201","0201","0201"};
  ids = {1,4,5};
  ...
  std::cout << "Initial speed: " << hklx.getSpeed(5) << std::endl;
  
  while (!(getchar() == 27));

  a = hklx.moveSpeed0201(200,5,LED_GREEN,12);
